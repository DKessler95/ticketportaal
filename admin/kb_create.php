...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title)) {
        ...
        if ($kbId) {
            ...
            header("refresh:2;url=kb_edit.php?id=$kbId");
        } else {
...
<head>
    ...
    <title>Create KB Article - <?php echo SITE_NAME; ?></title>
        ...
        <div class="row">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                    <h1 class="h2">Create Knowledge Base Article</h1>
                        ...
                        <form method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="title" name="title" 
                                       value="<?php echo escapeOutput($_POST['title'] ?? ''); ?>" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="content" name="content" rows="15" required><?php echo escapeOutput($_POST['content'] ?? ''); ?></textarea>
