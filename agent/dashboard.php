        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo SITE_URL; ?>/agent/dashboard.php">
        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="alert alert-warning">
                    ...
                    <strong>Warning:</strong> There are <?php echo count($overdueTickets); ?> overdue ticket(s) exceeding SLA.
                </div>
            </div>
        </div>
        <?php endif; ?>
                    ...
                    <div class="card-body">
                        <?php if (empty($tickets)): ?>
                            <div class="alert alert-info mb-0">
                                <i class="bi bi-info-circle"></i> No tickets found matching the selected filters.
                            </div>
                        <?php else: ?>
